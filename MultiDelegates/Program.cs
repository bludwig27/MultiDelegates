namespace assignment8ex1
{
    class Program
    {
        ...
        {
            myDelegate beatles = new myDelegate(HereComesTheSun.chorus);
            beatles += HereComesTheSun.verse1;
            beatles += HereComesTheSun.chorus;
            beatles+= HereComesTheSun.verse2;
            beatles+= HereComesTheSun.chorus2;
            beatles+= HereComesTheSun.verse3;
            beatles += HereComesTheSun.chorus;
            beatles += HereComesTheSun.chorus;
            beatles += HereComesTheSun.end;

            Console.WriteLine("Invoking multicast delegate now:");
            beatles();
